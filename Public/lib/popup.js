	 ...
	 W.Popup = function() {
		...
		function constructor() {
			$("body").append("<div id='mask_TELANX' style='position:fixed;top:0;width:100%;height:100%;background:rgba(0,0,0,0.6);display:none;'>"
						...
						+ "</div>"
						+ "</div>"
						+ "<div id='tip_TELANX' style='position:fixed;top:45%;width:200px;color:#fff;height:50px;text-align:center;left:45%;line-height:50px;background:rgba(0,0,0,0.6);display:none'></div>"
						);
